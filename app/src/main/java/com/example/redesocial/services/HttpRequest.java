...
public class HttpRequest {
    ...
    public HttpRequest( String requestUrl, String method) {
    ...
    public void handleResult(Context context, JSONObject response) throws JSONException {
        int status = response.getInt("status");
        String messege = response.getString("message");

        String responseText = messege;
        if(status != Const.SUCCESS && status != Const.UNAUTHORIZED){
